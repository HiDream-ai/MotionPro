...
output_dir = "all_results/test/motionpro_s"
...
class Drag:
    ...
    def run(self, first_frame_path, tracking_points, inference_batch_size, motion_bucket_id, first_frame_path_mask=None, img_ratio=None):
