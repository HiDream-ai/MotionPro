...
from sgm.modules.diffusionmodules.video_model_flow import VideoUNet_flow
from sgm.modules.diffusionmodules.denoiser import Denoiser
from sgm.modules.diffusionmodules.denoiser_scaling import VScalingWithEDMcNoise
...
from vtdm.lora import inject_trainable_lora, inject_trainable_lora_extended, extract_lora_ups_down, _find_modules
import random
...
class Args:
    ...
    first_stage_config = {
        ...
        'encoder_config':{'target': 'sgm.modules.diffusionmodules.model.Encoder',
        ...
        'decoder_config':{'target': 'sgm.modules.autoencoding.temporal_ae.VideoDecoder',
                          'params': {'attn_type': 'vanilla',
                                     'double_z': True,
                                     'z_channels': 4,
                                     'resolution': 256,
    ...
    sampler_config = {
        ...
        'guider_config': {'target': 'sgm.modules.diffusionmodules.guiders.LinearPredictionGuider',
...
class Net(nn.Module):
    def __init__(self, args):
        ...
        self.model = OpenAIWrapper(model)                           # for more efficient model inference..
